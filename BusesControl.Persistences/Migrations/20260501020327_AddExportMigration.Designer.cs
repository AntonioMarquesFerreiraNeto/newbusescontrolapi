...
namespace BusesControl.Persistence.Migrations
{
    ...
    [Migration("20260501020327_AddExportMigration")]
    partial class AddExportMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusesControl.Entities.Models.v1.ContactModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BusesControl.Entities.Models.v1.ExportModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BusesControl.Entities.Models.v1.FeatureFlagModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("70cb67f1-2ce3-47e3-802c-b8ba144a1aac"),
                            CreatedAt = new DateTime(2025, 8, 9, 14, 49, 0, 0, DateTimeKind.Unspecified),
                            Enabled = true,
                            Key = "automated-payment",
                            Name = "Processamento de pagamentos automáticos"
                        },
                        new
                        {
                            Id = new Guid("043d8647-27d8-475f-865b-7ca006f49f4e"),
                            CreatedAt = new DateTime(2025, 8, 9, 14, 49, 0, 0, DateTimeKind.Unspecified),
                            Enabled = true,
                            Key = "automated-overdue-invoice-processing",
                            Name = "Processamento de faturas vencidas"
                        },
                        new
                        {
                            Id = new Guid("4f810771-5945-46ee-86e9-0b9f3cff186a"),
                            CreatedAt = new DateTime(2025, 8, 9, 14, 49, 0, 0, DateTimeKind.Unspecified),
                            Enabled = true,
                            Key = "automated-contract-finalization",
                            Name = "Finalização automática de contratos"
                        },
                        new
                        {
                            Id = new Guid("c0e27d51-cd40-47ff-be6c-8b35affa06d6"),
                            CreatedAt = new DateTime(2025, 8, 9, 14, 49, 0, 0, DateTimeKind.Unspecified),
                            Enabled = true,
                            Key = "automated-cancel-process-termination",
                            Name = "Cancelamento e encerramento de processos"
                        },
                        new
                        {
                            Id = new Guid("a6bf0ab3-580f-4713-8b62-1c0655a83a3e"),
                            CreatedAt = new DateTime(2025, 8, 9, 14, 49, 0, 0, DateTimeKind.Unspecified),
                            Enabled = true,
                            Key = "automated-change-webhook",
                            Name = "Atualização automática de webhooks"
                        });
                });
            ...
            modelBuilder.Entity("BusesControl.Entities.Models.v1.TwoFaModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
