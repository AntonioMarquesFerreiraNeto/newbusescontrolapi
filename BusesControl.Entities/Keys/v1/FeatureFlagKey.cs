namespace BusesControl.Entities.Keys.v1
{
    public class FeatureFlagKey
    {
        public const string AutomatedPayment = "automated-payment";
        public const string AutomatedOverdueInvoiceProcessing = "automated-overdue-invoice-processing";
