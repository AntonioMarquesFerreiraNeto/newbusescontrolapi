...
public class ContractDescriptionUpdateRequestValidator : AbstractValidator<ContractDescriptionUpdateRequest>
{
    public ContractDescriptionUpdateRequestValidator()
    {
        RuleFor(x => x.Owner)
